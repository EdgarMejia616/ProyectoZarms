...
$sql = "SELECT nombre_producto, precio, descripcion, imagen, estado FROM producto WHERE categoria = 'Bebe' AND estado = 'Activo'";
...
<head>
    ...
    <title>Productos para Bebes</title>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">List of baby products</span>
                </nav>
            </div>
        </div>
    </div>
