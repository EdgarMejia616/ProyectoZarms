...
$sql = "SELECT nombre_producto, precio, descripcion, imagen, estado FROM producto WHERE categoria = 'Salud y Belleza' AND estado = 'Activo'";
...
<head>
    ...
    <title>Productos para la Salud y la Belleza</title>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">List of health products</span>
                </nav>
            </div>
        </div>
    </div>
