...
$sql = "SELECT nombre_producto, precio, descripcion, imagen, estado FROM producto WHERE categoria = 'Alimentos' AND estado = 'Activo'";
...
<head>
    ...
    <title>Productos de Alimentos</title>
...
while ($row = $result->fetch_assoc()) {
    ...
    echo '<img src="' . $image_url . '" alt="' . $nombre_producto . '">';
    echo '<h3>' . $nombre_producto . '</h3>';
