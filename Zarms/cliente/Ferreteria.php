...
$sql = "SELECT nombre_producto, precio, descripcion, imagen, estado FROM producto WHERE categoria = 'Ferreteria y Mejoras para el Hogar' AND estado = 'Activo'";
...
<head>
    ...
    <title>Productos para mejorar el Hogar</title>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">List of products for hardware and home improvement</span>
                </nav>
            </div>
        </div>
    </div>
