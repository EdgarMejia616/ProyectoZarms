...
$sql = "SELECT nombre_producto, precio, descripcion, imagen, estado FROM producto WHERE categoria = 'Alcohol' AND estado = 'Activo'";
...
<head>
    ...
    <title>Productos Alcoholicos</title>
...
<body>
  ...
  <div class="search-container">
    <input type="text" id="search-input" name="query" placeholder="Buscar Bebidas Alcoholicas" class="search-input" required>
